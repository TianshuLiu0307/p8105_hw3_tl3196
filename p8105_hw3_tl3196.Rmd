...
This data set contains ``r ncol(accel_df)`` variables, which are ``r colnames(accel_df)``. The variables, data types and explanations are shown in the table below:
...
From the plots of 5 weeks, we can conclude that the number of activities happened per day first increses
