...
First, check the current temperature values in the data set.
...
The most commonly observed value of snowfall is `0`, since most of the days in New York in a year do not snow.
